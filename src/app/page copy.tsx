...
export default function Page() {
  ...
  return (
    <main className="relative mx-auto max-w-5xl p-6 space-y-6">
      ...
      <section
        ...
        className="rounded-2xl border border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md shadow-sm p-5 outline-none focus:ring-2 focus:ring-sky-400/50"
      >
